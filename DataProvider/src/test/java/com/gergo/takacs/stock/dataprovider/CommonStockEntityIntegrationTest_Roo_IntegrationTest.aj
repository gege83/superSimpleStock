...
privileged aspect CommonStockEntityIntegrationTest_Roo_IntegrationTest {
	...
	@Autowired
	StockRepository CommonStockEntityIntegrationTest.stockRepository;

	@Test
	public void CommonStockEntityIntegrationTest.testCount() {
	...
	@Test
	public void CommonStockEntityIntegrationTest.testFind() {
	...
	@Test
	public void CommonStockEntityIntegrationTest.testFindAll() {
		Assert.assertNotNull("Data on demand for 'CommonStockEntity' failed to initialize correctly",
				dod.getRandomCommonStockEntity());
		long count = stockRepository.count();
		Assert.assertTrue(
	...
	@Test
	public void CommonStockEntityIntegrationTest.testFindEntries() {
		Assert.assertNotNull("Data on demand for 'CommonStockEntity' failed to initialize correctly",
				dod.getRandomCommonStockEntity());
		long count = stockRepository.count();
		if (count > 20)
	...
	@Test
	public void CommonStockEntityIntegrationTest.testSaveUpdate() {
		CommonStockEntity obj = dod.getRandomCommonStockEntity();
		Assert.assertNotNull("Data on demand for 'CommonStockEntity' failed to initialize correctly", obj);
		Long id = obj.getId();
		Assert.assertNotNull("Data on demand for 'CommonStockEntity' failed to provide an identifier", id);
		...
		boolean modified = dod.modifyCommonStockEntity(obj);
		Integer currentVersion = obj.getVersion();
		CommonStockEntity merged = (CommonStockEntity) stockRepository.save(obj);
		stockRepository.flush();
	...
	@Test
	public void CommonStockEntityIntegrationTest.testSave() {
		Assert.assertNotNull("Data on demand for 'CommonStockEntity' failed to initialize correctly",
				dod.getRandomCommonStockEntity());
	...
	@Test
	public void CommonStockEntityIntegrationTest.testDelete() {
		CommonStockEntity obj = dod.getRandomCommonStockEntity();
		Assert.assertNotNull("Data on demand for 'CommonStockEntity' failed to initialize correctly", obj);
		Long id = obj.getId();
		Assert.assertNotNull("Data on demand for 'CommonStockEntity' failed to provide an identifier", id);
