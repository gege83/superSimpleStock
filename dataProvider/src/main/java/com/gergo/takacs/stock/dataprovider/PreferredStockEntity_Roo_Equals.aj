...
privileged aspect PreferredStockEntity_Roo_Equals {
    ...
    public boolean PreferredStockEntity.equals(Object obj) {
        ...
        return new EqualsBuilder().append(fixedDividend, rhs.fixedDividend).append(id, rhs.id).append(parValue, rhs.parValue).append(symbol, rhs.symbol).append(tickerPrice, rhs.tickerPrice).append(type, rhs.type).isEquals();
    }
    
    public int PreferredStockEntity.hashCode() {
        return new HashCodeBuilder().append(fixedDividend).append(id).append(parValue).append(symbol).append(tickerPrice).append(type).toHashCode();
    }
