...
public class UnmodifiabelStockInformation implements StockInformation {
	...
	public UnmodifiabelStockInformation(String symbol, double dividendYield, double peRatio, double stockPrice) {
		this.symbol = symbol;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		UnmodifiabelStockInformation other = (UnmodifiabelStockInformation) obj;
	...
	public String toString() {
		return "UnmodifiabelStockInformation [symbol=" + symbol + ", dividendYield=" + dividendYield + ", peRatio="
